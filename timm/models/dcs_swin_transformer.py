...
__all__ = ['DCS_SwinTransformer']  # model_registry will add each entrypoint fn to this
...
class DCS_SwinTransformerBlock(nn.Module):
    def __init__(
...
class DCS_SwinTransformer(nn.Module):
...
def _create_dcs_swin_transformer(variant, pretrained=False, **kwargs):
    model = build_model_with_cfg(
        DCS_SwinTransformer, variant, pretrained,
...
@register_model
def dcs_swin_base_patch4_window12_384(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=12, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_base_patch4_window12_384', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_base_patch4_window7_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_base_patch4_window7_224', pretrained=pretrained, **model_kwargs)



@register_model
def dcs_swin_small_patch4_window7_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_small_patch4_window7_224', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_tiny_patch4_window7_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_tiny_patch4_window7_224', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_base_patch4_window12_384_in22k(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=12, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_base_patch4_window12_384_in22k', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_base_patch4_window7_224_in22k(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32), **kwargs)
    return _create_dcs_swin_transformer('swin_base_patch4_window7_224_in22k', pretrained=pretrained, **model_kwargs)



@register_model
def dcs_swin_s3_tiny_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=(7, 7, 14, 7), embed_dim=96, depths=(2, 2, 6, 2),
        num_heads=(3, 6, 12, 24), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_s3_tiny_224', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_s3_small_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=(14, 14, 14, 7), embed_dim=96, depths=(2, 2, 18, 2),
        num_heads=(3, 6, 12, 24), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_s3_small_224', pretrained=pretrained, **model_kwargs)


@register_model
def dcs_swin_s3_base_224(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=(7, 7, 14, 7), embed_dim=96, depths=(2, 2, 30, 2),
        num_heads=(3, 6, 12, 24), **kwargs)
    return _create_dcs_swin_transformer('dcs_swin_s3_base_224', pretrained=pretrained, **model_kwargs)
