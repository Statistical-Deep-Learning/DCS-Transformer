...
class DCS_VisionTransformer(nn.Module):
    def __init__(
            self,
            img_size=224,
            patch_size=16,
...
@torch.no_grad()
def _load_weights(model: DCS_VisionTransformer, checkpoint_path: str, prefix: str = ''):
...
def _create_vision_transformer(variant, pretrained=False, **kwargs):
    ...
    return build_model_with_cfg(
        DCS_VisionTransformer, variant, pretrained,
